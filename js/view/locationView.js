...
import { index } from "../service/locationService.js";

export let singleId = 0;

function render(location, next) {
    ...
    prevBtn.addEventListener('click', async () => {
        locationService.decrementIndex();
        const { results: response, next } = await locationService.getLocations();
